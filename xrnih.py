...
while True:
    ...
    print("       Github: https://github.com/4CEEHENGKEL")
...
while 1:
    port_bool = str(input("Bener nih port nya? [y/n]: "))
...
if port_mode == False:  # All ports.
    try:
        while True:
            ...
            sent += 1
            port += 1
            print("\033[32;1mXR Comunity Sent %s packets to %s through port:%s"%(sent, ip, port))
    except:
